...
class SerialReader(QtCore.QThread):
    samples_received = QtCore.Signal(object, int)
        ...
        try:
            ...
            while self._running:
                ...
                if chunk:
                    ...
                    if frames.shape[0]:
                        self.samples_received.emit(frames, time.time_ns())
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self, apply_offsets: bool) -> None:
        ...
        self.record_button = QtWidgets.QPushButton("Start CSV recording")
        self.record_button.clicked.connect(self.toggle_recording)
        controls.addWidget(self.record_button, 0, 6)

        self.clear_button = QtWidgets.QPushButton("Clear plot")
        self.clear_button.clicked.connect(self.clear_data)
        controls.addWidget(self.clear_button, 0, 7)
        ...
        controls.addWidget(self.status_label, 1, 7)
    ...
    def on_samples_received(
        self, raw_samples: np.ndarray, receive_time_ns: int
    ) -> None:
